...
# # S E R V E R S
alias         cc2="echo '${myssh} cc2'; ${myssh} ccscs2"
alias         cc3="echo '${myssh} cc3'; ${myssh} ccscs3"
alias         cc4="echo '${myssh} cc4'; ${myssh} ccscs4"
alias         cc5="echo '${myssh} cc5'; ${myssh} ccscs5"
alias         cc6="echo '${myssh} cc6'; ${myssh} ccscs6"
alias         cc7="echo '${myssh} cc7'; ${myssh} ccscs7"
alias         cc8="echo '${myssh} cc8'; ${myssh} ccscs8"

alias         cctc="echo '${myssh} ccs-tc'; ${myssh} ccs-tc"
